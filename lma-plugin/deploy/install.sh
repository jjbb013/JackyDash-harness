...
=============================================================================
 ✅ 部署完成
=============================================================================
   站点首页    https://${DOMAIN}/login   （未登录访问 / 会自动跳这里）
   聊天 UI     https://${DOMAIN}/         （登录后直接进入，不需要再拼 token）
   LMA 仪表盘  https://${DOMAIN}/lma/     （同一条会话，不会二次登录）
 ...
 下一步
   ...
   2) 打开 https://${DOMAIN}/ 用管理员登录（就是首页那道门；首登会强制改密）
